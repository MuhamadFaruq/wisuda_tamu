...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/barcode/{code}', [AttendanceController::class, 'lookup'])->name('barcode.lookup');
    ...
    Route::get('/barcode-png/{code}', [ReportController::class, 'barcodePng'])->name('barcodes.png');
